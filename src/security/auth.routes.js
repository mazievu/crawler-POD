...
/**
 * Creates Express Router mounting all authentication and API key management routes.
 */
function createAuthRouter(options = {}) {
  ...
  router.post(['/api-keys', '/api/auth/api-keys'], requireAuth, requireAdmin, async (req, res) => {
    try {
  ...
  // 7. Revoke API Key (Admin-only)
  router.delete(['/api-keys/:id', '/api/auth/api-keys/:id'], requireAuth, requireAdmin, async (req, res) => {
    try {
